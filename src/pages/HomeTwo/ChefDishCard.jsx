    ...
    <div className="row">
      <Toast onClose={() => setShow(false)} show={show}>
        <Toast.Header>
          ...
          <strong className="me-auto">Added To Favorite <FcLike></FcLike></strong>
        </Toast.Header>
      </Toast>
      ...
      {datas.map((data) => (
        ...
        >
          ...
          {
            show?
            <Button  onClick={() => setShow(true)} className="border disabled" style={{ backgroundColor: "#D54215" }}>
            Added Favorite
          </Button>:
          <Button  onClick={() => setShow(true)} className="border" style={{ backgroundColor: "#D54215" }}>
          Add Favorite
        </Button>
          }
        </div>
